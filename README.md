# Phonogeneli
Phonogeneli is a Max for Live device. It's a quirky tape loop effect and is available for free. Download the file phonogeneli.amxd in the folder [frozen](https://github.com/nilsmango/phonogeneli/frozen) to use it. Check the details below.
